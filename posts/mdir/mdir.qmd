...
To showcase the Multiple Dataset Integration (**MDI**) method, we generate three datasets with correlated clustering structures. To do this we load the appropriate packages and write some functions to ensure our data do have related generating structure.
