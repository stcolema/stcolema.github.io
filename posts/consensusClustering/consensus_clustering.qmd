...
It appears that consensus clustering can describe the posterior distribution quite well, placing an appropriate amount of mass on each potential partition.
